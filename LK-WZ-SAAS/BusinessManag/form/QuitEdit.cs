...
{
    public partial class QuitEdit : Form
    {
        ...
        public QuitEdit(Dictionary<string, string> info,int isEdit,IAppContent app)
        {
            ...
            this.selTextInpt3.SelParam = "4|1|1|" + His.his.Choscode + "|{key}|{key}|{key}|{key}";
        ...
        private void SaveData()
        {
            ...
            ac.Action = "LKWZSVR.lkwz.WZQuit.SaveQuit";
            if (outInfo==null)
            {
                ac.Sql = "AddOutMain";
                ac.Add("OUTID", null);
        ...
        private void loadData()
        {
            ...
            if (tb != null && tb.Rows.Count > 0)
            {
                ...
                KuFangJiBie= "|" + tb.Rows[0]["IFNDWARE"].ToString() + "|" + tb.Rows[0]["IFRDWARE"].ToString()+"|0";
            }
        ...
        private void QuitEdit_Load(object sender, EventArgs e)
        {
        ...
        private void toolStripButton5_Click(object sender, EventArgs e)
        {
            if (outInfo != null)
            {
                ...
                if (tb != null && tb.Rows.Count > 0)
                {
                    ...
                    pp.Add("BiaoTi", tb.Rows[0][0].ToString() + "  【" + outInfo["ChuKuKuFangName"] + "】  " + "退回单");
                    pp.Add("FangXiang", "由  【" + outInfo["ChuKuKuFangName"] + "】  退回到  【" + outInfo["MuDiKuFangName"] + "】");
                    pp.Add("Time", "时间：" + tb.Rows[0][5].ToString());
                    pp.Add("LeiBie", "类别：退回单");
