...
{
    public partial class WZSupply_Add : Form
    {
        public WZSupply_Add()
        {
            InitializeComponent();
        ...
        Dictionary<string, ObjItem> Info;
         public WZSupply_Add(Dictionary<string, ObjItem> Info)
        {
            this.Info = Info;
            isAdd = false;
            InitializeComponent();
        ...
        public WZSupply WZSupplyMain;
        private bool isAdd = true;
        public bool isSc = false;

        private void WZSupply_Add_Load(object sender, EventArgs e)
        {
            ...
            TvList.newBind().SetCacheKey("KsData").Load("FindHisInfoDict",null).Bind(this.ytComboBox_Pperty);
           ...
           // this.dateTimePicker1.Enabled = false;
            //this.ytComboBox_IfAfford.SelectedIndex = 0;
            //this.ytComboBox_IfMake.SelectedIndex = 0;
        ...
        void ac_ServiceLoad(object sender, YtClient.data.events.LoadEvent e)
        {
            ...
            else
            {
                ...
                this.ytComboBox_ifUse.SelectedIndex = -1;
