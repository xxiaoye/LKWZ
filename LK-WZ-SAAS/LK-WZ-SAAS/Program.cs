...
namespace LK_WZ_SAAS
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            SysSet.LinkTel = "服务热线: 4006613506转1 ";//4006613506转1 
            SysSet.LinkQQ = "企业QQ：800013506";//800013506
            //SysSet.LinkTel = "";
            //SysSet.LinkQQ = "";
           ...
           //  SysSet.MenuName = "xzmenu";//不知道干啥的
            SysSet.MenuName = "lkwzmenu";//不知道干啥的allmenu
            ...
            SysSet.LoginSuc = new LoginSucHandle(delegate(LoadEvent e, string sjh, string userPwd, Sys login)
            {
               ...
               His.his.postName = dt.Rows[0]["职务"].ToString();//131212
                His.his.DeptName = dt.Rows[0]["科室名称"].ToString();
               His.his.DeptID = dt.Rows[0]["科室ID"].ToString(); //131212
             His.his.DoctorID = dt.Rows[0]["医生ID"].ToString(); //131212
