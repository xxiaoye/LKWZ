...
namespace LKWZSVR
{
    public class Login:IEx
    {
        ...
        public object Run(YiTian.db.Dao dao, YtService.data.OptData data, out string msg)
        {
         ...
         " a.efficet,a.Fixedflag,b.名称 as 科室名称,a.mobilephone ,z.名称 as 职务,a.userid as 用户ID " +
          " ,b.ID as 科室ID,s.ID as 医生ID    from  his.用户表 a  left join  his.医生表 s on a.useraccount=s.useraccount "+
          " and a.choscode=s.choscode left join  his.科室表 b on s.科室=b.ID and a.choscode=b.choscode left join  his.职务表 z "+
          " on s.职务=z.id where a.Useraccount = ? ", new object[] { data.UserName });
            /*select  a.UserID,a.Useraccount,a.Userpassword,a.Userpower,a.Name,a.性别,a.cHosCode,
         a.efficet,a.Fixedflag,b.名称 as 科室名称,a.mobilephone ,z.名称 as 职务,a.userid as 用户ID
          ,b.ID as 科室ID,s.ID as 医生ID    from  his.用户表 a 
     left join  his.医生表 s on a.useraccount=s.useraccount and a.choscode=s.choscode
     left join  his.科室表 b on s.科室=b.ID and a.choscode=b.choscode left join  his.职务表 z on s.职务=z.id
             
             
              select a.UserID,a.Useraccount,a.Userpassword,a.Userpower,a.Name,a.性别,a.cHosCode,"+
      "a.efficet,a.Fixedflag,b.名称 as 科室名称,a.mobilephone from His.用户表 a  left join His.科室表 b on   a.所属科室=b.id " +
       "  where a.Useraccount = ?
    */
