...
namespace LKWZSVR.lkwz.WZQuit
{
    public class SaveQuit : IEx
    {
        #region IEx 成员
        ...
        public object Run(YiTian.db.Dao dao, YtService.data.OptData data, out string msg)
        {
               ...
               // recipe.IndexOf('_');
                ...
                foreach (string r in XbTable)
                {
                    ...
                    else if (xbValue[0] == "3")  //根据ID删除细表中的项
                    {
                       ...
                       // data1.Params = new object[] { xbValue[1] };
            ...
            else if (data.Sql.Equals("QueRenDiaoBo"))
            {
                ...
                DataRow InKind=dao.Fd("select * from LKWZ.DICTWZINOUT where IfUse=1 and IOFlag=0 and OPFlag=4 and CHOSCode="+data.Param["CHOSCODE"].ToString()).Rows[0];
