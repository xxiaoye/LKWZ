...
namespace StatQuery
{
    public partial class WZPlanQuery : Form, IPlug
    {
        public WZPlanQuery()
        {
            InitializeComponent();
      ...
      //  private Panel[] plis = null;
        ...
        private void Search_button_Click(object sender, EventArgs e)
        {
            ...
            {
                sql.Add("and a.GYS=?", this.selTextInpt_supply.Text);
            }
            ...
            else
            {
                ...
                {
                    sql.Add("and a.SCS=?", this.selTextInpt_Factor.Value);
                }
            }
            ...
            this.JinEHeJi.Text = this.dataGView2.Sum("采购金额").ToString() + "元";
        ...
        private void WZPlanQuery_Load(object sender, EventArgs e)
        {
           ...
           // TvList.newBind().Load("Chang_LSDanWeiBianMa", null).Bind(this.lsunitcode);
            ...
            TvList.newBind().Load("WZUseRec_Stock", new object[] { His.his.Choscode }).Bind(this.Column1);
            ...
            TvList.newBind().Load("Chang_LSDanWeiBianMa", new object[] { His.his.Choscode }).Bind(this.unit);

            //this.dataGView1.Url = "StatQuery_WZInMainSearchaschanger";
            this.dataGView2.Url = "StatQuery_WZPlanDetailSearchaschanger";
