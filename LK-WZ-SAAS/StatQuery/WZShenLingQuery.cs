...
namespace StatQuery
{
    public partial class WZShenLingQuery : Form, IPlug
    {
        private BusinessManag.form.ShenLingEdit editForm = null;
        public WZShenLingQuery()
        {
            InitializeComponent();
        }
      //  #region IPlug 成员
      ...
      //  #endregion
        ...
        private void Search_button_Click(object sender, EventArgs e)
        {
            ...
            if (this.selTextInpt_Ware.Value != null)
            {
                ...
                sql.Add("and b.TARGETWARECODE=?", this.selTextInpt_Ware.Value);
            }
            ...
            {
                sql.Add("and a.SCS liek ?", "%" + this.selTextInpt_Factor.Text.Trim().ToString() + "%");
               // sql.Add("and a.SCS=?", this.selTextInpt_Factor.Text.Trim().ToString());
            }
            else
            {
            ...
            if (this.selTextInpt_SendUser.Value != null)
            {
                sql.Add("and b.SHOUTUSERID=?", this.selTextInpt_SendUser.Value);
            }

            if (this.selTextInpt_GosWare.Value != null)
            {
                sql.Add("and b.WARECODE=?", this.selTextInpt_GosWare.Value);
            }
  ...
  this.CaiGouJinEHeJi.Text = this.dataGView1.Sum("采购金额").ToString() + "元";
  this.LingShouJinEHeJi.Text = this.dataGView1.Sum("零售金额").ToString() + "元";
        ...
        private void WZShenLingQuery_Load(object sender, EventArgs e)
        {
            ...
            this.selTextInpt_Ware.Sql = "Query_GetOutWare"; //"Query_GetInWareaschanger";//库房
            ...
            this.selTextInpt_supply.SelParam = "{key}|{key}|{key}|{key}|{key}|" + His.his.Choscode;
            ...
            this.selTextInpt_SendUser.Sql = "Query_GetSurer";//确认人
            this.selTextInpt_SendUser.SelParam = "{key}|{key}|{key}|{key}|" + His.his.Choscode;
            ...
            this.dataGView1.Url = "Query_WZShenLingDetailSearchaschanger";
        ...
        private void dataGView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            DataTable tb = ld.Find("DbQueryFindWzPlanMainById", new object[] { this.dataGView1.CurrentRow.Cells["PLANID"].Value });

            if (tb != null && tb.Rows.Count > 0)
            {
                Dictionary<string, string> info = new Dictionary<string, string>() { };
                info.Add("MuDiKuFangCode", tb.Rows[0]["WARECODE"].ToString());
                info.Add("MuDiKuFangName", this.dataGView1.CurrentRow.Cells["Column2"].Value.ToString());
                info.Add("ChuKuKuFangCode", tb.Rows[0]["TARGETWARECODE"].ToString());
                info.Add("ChuKuKuFangName", this.dataGView1.CurrentRow.Cells["Column1"].Value.ToString());
                info.Add("BeiZhu", this.dataGView1.CurrentRow.Cells["BeiZhu"].Value.ToString());
                info.Add("ChuKuZongJinE", this.dataGView1.CurrentRow.Cells["ChuKuJinE"].Value.ToString());
                info.Add("RuKuZongJinE", this.dataGView1.CurrentRow.Cells["RuKuJinE"].Value.ToString());
                info.Add("outID", this.dataGView1.CurrentRow.Cells["PLANID"].Value.ToString());
                info.Add("outDate", tb.Rows[0]["PLANDATE"].ToString());
                this.editForm = new  BusinessManag.form.ShenLingEdit(info, 0, app);
                ...
                //info.Add("outID", this.dataGView1.CurrentRow.Cells["Column24"].Value.ToString());
