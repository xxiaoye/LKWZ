...
namespace StatQuery
{
    public partial class WZTiaoJiaQuery : Form, IPlug
    {
        public WZTiaoJiaQuery()
        {
            InitializeComponent();
        }
        #region IPlug 成员
  ...
  this.TiaoSu.Text = this.dataGView2.RowCount.ToString() + "条"; 
               
        }

        private void WZTiaoJiaQuery_Load(object sender, EventArgs e)
        {
            TvList.newBind().Load("Chang_LSDanWeiBianMa",null).Bind(this.Column28);
            ...
            this.selTextInpt_Ware.Sql = "StatQuery_GetWZTiaoJiaWareaschanger";//库房
            ...
            this.dataGView2.Url = "StatQuery_WZTiaoJiaDetailSearchaschanger";
