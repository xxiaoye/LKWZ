...
namespace StatQuery
{
    public partial class WZTuiHuiQuery : Form, IPlug
    {
        private BusinessManag.form.QuitEdit editForm = null;
        public WZTuiHuiQuery()
        {
            InitializeComponent();
        }
      //  #region IPlug 成员
  ...
  this.RuKuJinEHeJi.Text = this.dataGView2.Sum("入库金额").ToString() + "元";
        ...
        private void WZTuiHuiQuery_Load(object sender, EventArgs e)
        {
            ...
            this.dataGView2.Url = "Query_WZTuiHuiDetailSearchaschanger";
        ...
        private void dataGView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (tb != null && tb.Rows.Count > 0)
            {
                ...
                this.editForm = new BusinessManag.form.QuitEdit(info, 0, app);
